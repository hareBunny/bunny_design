...
const MainHeader = () => (
    <header className="editor-main-header col-start-1 row-start-1 flex h-[var(--editor-header-height)] min-w-0 items-center justify-between border-b border-[#ededed] bg-[#f6f6f6] px-6">
