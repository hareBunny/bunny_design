...
export const FRAME_INSPECTOR_PROPERTIES = {
    ...
    gap: propertyMap.get('gap')!,
    padding: propertyMap.get('padding')!,
    justifyContent: propertyMap.get('justifyContent')!,
    alignItems: propertyMap.get('alignItems')!,
    clip: propertyMap.get('clip')!,
    opacity: propertyMap.get('opacity')!,
